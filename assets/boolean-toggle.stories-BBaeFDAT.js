...
The value must have reference equality with the option in order to be selected.`,name:"value",required:!1,type:{name:"any"}},ref:{defaultValue:null,description:"",name:"ref",required:!1,type:{name:"Ref<unknown>"}},theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"Theme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"ElementType<any, keyof IntrinsicElements>"}}}}}catch{}const ge={component:V,title:"Components/Toggle/Boolean Toggle",parameters:{design:{type:"figma",url:"https://www.figma.com/file/TmLDXXPGbkFMMk1K1Gexmg/5.-Set-up-equity-placement-form?type=design&node-id=1100-265500&mode=dev"}}},t=e=>{const[p,n]=T.useState(e.value);return b(V,{...e,value:p,onChange:(l,m)=>{e.onChange&&e.onChange(l,m),n(m)}})},r=t.bind({});r.args={value:!0};const s=t.bind({});s.args={value:!1};const u=t.bind({});u.args={value:null};const i=t.bind({});i.args={value:!0,disabled:!0};const d=t.bind({});d.args={value:!1,disabled:!0};const c=t.bind({});c.args={value:null,disabled:!0};const g=t.bind({});g.args={value:!0,trueText:"Yes Please",falseText:"No Thank You"};var S,M,E;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  ...
  return <BooleanToggle {...args} value={value} onChange={handleValueChange} />;
}`,...(O=(W=g.parameters)==null?void 0:W.docs)==null?void 0:O.source}}};const pe=["True","False","Null","DisabledTrue","DisabledFalse","DisabledNull","CustomTextValues"];export{g as CustomTextValues,d as DisabledFalse,c as DisabledNull,i as DisabledTrue,s as False,u as Null,r as True,pe as __namedExportsOrder,ge as default};
